...
if not st.session_state.expenses:
    ...
    with tab2:
        ...
        # Top section with category breakdown
        ...
        for idx, (col, row) in enumerate(zip(cols, category_sum.itertuples())):
            with col:
        ...
        with col2:
            ...
            fig_bar = px.bar(
                ...
                x='category',
                y='amount',
                title='📊 Category-wise Spending Analysis',
                color='amount',
        ...
        fig_line = px.area(
            ...
            x='date',
            y='amount',
            title='Daily Expense Progression',
            markers=True
        )
        fig_line.update_traces(
            line_color='#DC143C',
            line_width=4,
            marker=dict(size=12, color='#8B0000', line=dict(color='white', width=2)),
            fill='tonexty',
...
st.markdown("""
    <div class='footer-box'>
        ...
        <p style="font-size: 1.3em; margin-top: 15px;">Made with ❤️ by <strong style="color: #DC143C;">MAYANK</strong></p>
